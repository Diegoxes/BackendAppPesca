...
module.exports = (sequelize, type) => {
  var DespachoCombustibleImagen = sequelize.define('despacho_combustible_imagen',
    {
      id: {
        primaryKey: true,
        type: type.UUID,
  ...
  DespachoCombustibleImagen.associate = function (models) {
    
  };

  return DespachoCombustibleImagen;
